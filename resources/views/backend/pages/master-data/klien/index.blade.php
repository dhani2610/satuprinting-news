                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="float-right mb-2">
                            @if (Auth::guard('admin')->user()->can('klien.create'))
                                ...
                                <div class="offcanvas offcanvas-end" tabindex="-1" id="create"
                                    ...
                                    <div class="offcanvas-header">
                                        <h5 id="offcanvasActivityAdd" class="offcanvas-title">Add Klien</h5>
                                    ...
                                    @foreach ($kliens as $klien)
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    @if ($klien->image != null)
                                                    <img src="{{ asset('assets/img/klien/'.$klien->image) }}" alt="" style="max-width: 200px;">
                                                    @else
                                                    -
                                                    @endif
                                                </center>
                                            ...
                                            <td>
                                                <div class="d-inline-block text-nowrap">
                                                    @if (Auth::guard('admin')->user()->can('klien.edit'))
                                                        <button class="btn btn-sm btn-icon" type="button"
                                                            data-bs-toggle="offcanvas"
                                                            data-bs-target="#edit-{{ $klien->id }}"
                                                            aria-controls="offcanvasEnd">
                                                        ...
                                                        <div class="offcanvas offcanvas-end" tabindex="-1"
                                                            ...
                                                            <div class="offcanvas-body mx-0 flex-grow-0">
                                                                <form action="{{ route('klien.update', $klien->id) }}"
                                                    ...
                                                    @if (Auth::guard('admin')->user()->can('klien.delete'))
                                                        <button class="btn btn-sm btn-icon"
                                                            onclick="confirmDelete('{{ route('klien.destroy', $klien->id) }}')">
