                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="float-right mb-2">
                            @if (Auth::guard('admin')->user()->can('portofolio.create'))
                                ...
                                <div class="offcanvas offcanvas-end" tabindex="-1" id="create"
                                    ...
                                    <div class="offcanvas-header">
                                        <h5 id="offcanvasActivityAdd" class="offcanvas-title">Add Portofolio</h5>
                                ...
                                <tbody>
                                    @foreach ($portofolios as $portofolio)
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    @if ($portofolio->image != null)
                                                    <img src="{{ asset('assets/img/Portofolio/'.$portofolio->image) }}" alt="" style="max-width: 200px;">
                                                    @else
                                                    -
                                                    @endif
                                                </center>
                                            ...
                                            <td>
                                                <div class="d-inline-block text-nowrap">
                                                    @if (Auth::guard('admin')->user()->can('portofolio.edit'))
                                                        <button class="btn btn-sm btn-icon" type="button"
                                                            data-bs-toggle="offcanvas"
                                                            data-bs-target="#edit-{{ $portofolio->id }}"
                                                            aria-controls="offcanvasEnd">
                                                            <i class="bx bx-edit"></i>
                                                        </button>
                                                        <div class="offcanvas offcanvas-end" tabindex="-1"
                                                            id="edit-{{ $portofolio->id }}"
                                                    ...
                                                    @if (Auth::guard('admin')->user()->can('portofolio.delete'))
                                                        <button class="btn btn-sm btn-icon"
                                                            onclick="confirmDelete('{{ route('portofolio.destroy', $portofolio->id) }}')">
