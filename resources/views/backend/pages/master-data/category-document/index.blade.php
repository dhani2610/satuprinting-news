                        ...
                        @if (Auth::guard('admin')->user()->can('category.document.create'))
                                ...
                                <div class="offcanvas offcanvas-end" tabindex="-1" id="create"
                                    ...
                                    <div class="offcanvas-header">
                                        <h5 id="offcanvasActivityAdd" class="offcanvas-title">Add Category</h5>
                                        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="offcanvas-body mx-0 flex-grow-0">
                                        <form action="{{ route('category-document.store') }}" method="POST"
                                            ...
                                            <div class="ecommerce-customer-add-shiping mb-3 pt-3">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="file" class="form-control" id="image" name="image" accept="/image" placeholder="Enter Category" value="" required>
                                                    </div>
                                                    <div class="form-group mb-3">
                               ...
                               <tr>
                                    ...
                                    <td>
                                        <center>
                                            ...
                                            <img src="{{ asset('assets/img/category/'.$category->image) }}" alt="" style="max-width: 100px;">
                                            @else
                                            -
                                            @endif
                                        </center>
                                    ...
                                    <td>
                                        <div class="d-inline-block text-nowrap">
                                            @if (Auth::guard('admin')->user()->can('category.document.edit'))
                                                ...
                                                aria-labelledby="offcanvasActivityAdd" aria-modal="true" role="dialog">
                                                <div class="offcanvas-header">
                                                    <h5 id="offcanvasActivityAdd" class="offcanvas-title">Edit Category</h5>
                                                    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                                                        aria-label="Close"></button>
                                                </div>
                                                <div class="offcanvas-body mx-0 flex-grow-0">
                                                    <form action="{{ route('category-document.update',$category->id) }}" method="POST"
                                                        enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="ecommerce-customer-add-shiping mb-3 pt-3">
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group mb-3">
                                                                    <label for="name" class="mb-3">Image</label>
                                                                    <input type="file" class="form-control" id="image" name="image" placeholder="Enter Category" value="">
                                                                </div>
                                                                <div class="form-group mb-3">
                                                                    <label for="name" class="mb-3">Category</label>
                                            ...
                                            <button class="btn btn-sm btn-icon" onclick="confirmDelete('{{ route('category-document.destroy', $category->id) }}')">
