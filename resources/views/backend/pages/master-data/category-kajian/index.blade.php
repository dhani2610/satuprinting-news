            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="float-right mb-2">
                        @if (Auth::guard('admin')->user()->can('category.kajian.create'))
                                ...
                                <div class="offcanvas offcanvas-end" tabindex="-1" id="create"
                                    ...
                                    <div class="offcanvas-header">
                                        <h5 id="offcanvasActivityAdd" class="offcanvas-title">Add Category Kajian</h5>
                                        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="offcanvas-body mx-0 flex-grow-0">
                                        <form action="{{ route('category-kajian.store') }}" method="POST"
                               ...
                               <tr>
                                    ...
                                    <td>
                                        <div class="d-inline-block text-nowrap">
                                            @if (Auth::guard('admin')->user()->can('category.kajian.edit'))
                                                ...
                                                aria-labelledby="offcanvasActivityAdd" aria-modal="true" role="dialog">
                                                <div class="offcanvas-header">
                                                    <h5 id="offcanvasActivityAdd" class="offcanvas-title">Edit Category Kajian</h5>
                                                    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                                                        aria-label="Close"></button>
                                                </div>
                                                <div class="offcanvas-body mx-0 flex-grow-0">
                                                    <form action="{{ route('category-kajian.update',$category->id) }}" method="POST"
                                                        enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="ecommerce-customer-add-shiping mb-3 pt-3">
                                            ...
                                            @if (Auth::guard('admin')->user()->can('category.kajian.delete'))
                                            <button class="btn btn-sm btn-icon" onclick="confirmDelete('{{ route('category-kajian.destroy', $category->id) }}')">
