                            ...
                            <div class="d-flex justify-content-between align-items-center row py-3 gap-3 gap-md-0">
                                ...
                                <div class="col-md-3 statusFilter">
                                    <select id="statusFilter" name="status" class=" form-select text-capitalize"
                                        ...
                                        <option value="2" {{ Request::get('status') == 2 ? 'selected' : '' }}>Approve
                                        </option>
                                        <option value="1" {{ Request::get('status') == 1 ? 'selected' : '' }}>Waiting
                                        </option>
                                    </select>
                                </div>
                            </div>
                                    ...
                                    @foreach ($assignment as $asg)
                                        <tr>
                                            @php
                                                ...
                                                if ($asg->category == 'External' || $asg->category == null){
                                            ...
                                            <td>{{ $asg->tujuan ?? '-' }}</td>
                                            <td>
                                                @if ($asg->category != null)
                                                    @if ($asg->category == 'Internal')
                                                        -
                                                    @else
                                                        {{ $cust->name ?? '-' }}
                                                    @endif
                                            ...
                                            <td>
                                                ...
                                                @if ($asg->category == 'External' || $asg->category == null)
                                                    ...
                                                    @endphp
                                                    @if (!empty($proj))
                                                    {{ $proj->name_project . ' | ' . $proj->no_project }}
                                                    @else
                                                    -
                                                    @endif
                                                @else
                                            ...
                                            <td>
                                                <div class="d-inline-block text-nowrap">
                                                    ...
                                                    @if (Auth::guard('admin')->user()->can('assignment.edit'))
                                                        <a href="{{ route('assignment.print', $asg->id) }}"
                                                            target="_blank" class="btn btn-sm btn-icon"><i
                                                            ...
                                                            <div class="offcanvas-body mx-0 flex-grow-0">
                                                                <form action="{{ route('assignment.update', $asg->id) }}"
                                                                    ...
                                                                    <div class="ecommerce-customer-add-shiping mb-3 pt-3">
                                                                        ...
                                                                        <div class="mb-4">
                                                                            <label class="form-label" for="category">Category</label>
                                                                            <select id="category{{ $asg->id }}" name="category" class="form-select" required onchange="toggleFieldsEdit('{{ $asg->id }}')">
                                                                                <option value="">Select</option>
                                                                                <option value="External" {{ $asg->category == 'External' ? 'selected' : '' }}>External</option>
                                                                                <option value="Internal" {{ $asg->category == 'Internal' ? 'selected' : '' }}>Internal</option>
                                                                            </select>
                                                                        </div>
                                                            
                                                                        <!-- Internal Activity Dropdown -->
                                                                        <div class="mb-4" id="activity-container{{ $asg->id }}" style="{{ $asg->category == 'Internal' ? '' : 'display: none;' }}">
                                                                            <label class="form-label" for="activity_category">Activity Internal</label>
                                                                            <select id="activity_category{{ $asg->id }}" name="activity_category" class="form-select" >
                                                                                <option value="">Select</option>
                                                                                <option value="Office" {{ $asg->activity_category == 'Office' ? 'selected' : '' }}>Office</option>
                                                                            </select>
                                                                        </div>
                                                            
                                                                        <!-- Customer Dropdown -->
                                                                        <div class="mb-4" id="customer-container{{ $asg->id }}" style="{{ $asg->category == 'External' ? '' : 'display: none;' }}">
                                                                            <label class="form-label" for="customer">Customer</label>
                                                                            <select id="customer{{ $asg->id }}" name="id_customer" class="form-select" onchange="GetProject(this.value)">
                                                                                <option value="">Select</option>
                                                                                @foreach ($customers as $cst)
                                                                                    <option value="{{ $cst->id }}" {{ $cst->id == $asg->id_customer ? 'selected' : '' }}>
                                                                                        {{ $cst->name }}
                                                                                    </option>
                                                                                @endforeach
                                                                            </select>
                                                                        ...
                                                                        <!-- Project Dropdown -->
                                                                        <div class="mb-4" id="project-container{{ $asg->id }}" style="{{ $asg->id_project ? '' : 'display: none;' }}">
                                                                            <label class="form-label" for="project">Project</label>
                                                                            <select id="project{{ $asg->id }}" name="id_project" class="list-project form-select">
                                                                                <option value="">Select</option>
                                                                            </select>
                                                                        </div>
