                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                <div class="form-row">
                                                                                    ...
                                                                                    <div class="form-group mb-2">
                                                                                        ...
                                                                                        <textarea disabled name="address" id="" class="form-control" cols="30" rows="10" required></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                                ...
                                                                                <div class="form-group mb-2">
                                                                                    <label for="name">Notes</label>
                                                                                    <textarea name="catatan" class="form-control" id="" cols="20" rows="10">{{ $quo->catatan }}</textarea>
                                                                                </div>
