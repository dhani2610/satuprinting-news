...
@section('content')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            const pphInput = $('input[name="pph"]');  // Add this line
            const totalPphInput = $('input[name="total_pph"]'); // Add this line
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            quotationDetail.forEach(detail => {
                                ...
                                newRow.find('.item-price').val(numberFormat(detail
                                    .price));
            ...
            // Trigger calculation when ppn input changes
    ...
    <script>
        ...
        function onChangeEdit(id_po) {
            ...
            $(document).on('keyup', modalSelector + ' .ppn-input', function() {
                calculateTotalEdit();
            });
