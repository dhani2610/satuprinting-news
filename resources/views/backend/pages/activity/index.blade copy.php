                                                            ...
                                                            <div class="offcanvas-body mx-0 flex-grow-0">
                                                                <form action="{{ route('activity.update', $act->id) }}"
                                                                    ...
                                                                    <div class="ecommerce-customer-add-shiping mb-3 pt-3">
                                                                        ...
                                                                        <div class="mb-4">
                                                                            <label class="form-label" for="category">Category</label>
                                                                            <select id="category{{ $act->id }}" name="category" class="form-select" required onchange="toggleFieldsEdit('{{ $act->id }}')">
                                                                                <option value="">Select</option>
                                                                                <option value="External" {{ $act->category == 'External' ? 'selected' : '' }}>External</option>
                                                                                <option value="Internal" {{ $act->category == 'Internal' ? 'selected' : '' }}>Internal</option>
                                                                            </select>
                                                                        </div>
                                                            
                                                                        <!-- Internal Activity Dropdown -->
                                                                        <div class="mb-4" id="activity-container{{ $act->id }}" style="{{ $act->category == 'Internal' ? '' : 'display: none;' }}">
                                                                            <label class="form-label" for="activity_category">Activity Internal</label>
                                                                            <select id="activity_category{{ $act->id }}" name="activity_category" class="form-select" required>
                                                                                <option value="">Select</option>
                                                                                <option value="Office" {{ $act->activity_category == 'Office' ? 'selected' : '' }}>Office</option>
                                                                            </select>
                                                                        </div>
                                                            
                                                                        <!-- Customer Dropdown -->
                                                                        <div class="mb-4" id="customer-container{{ $act->id }}" style="{{ $act->category == 'External' ? '' : 'display: none;' }}">
                                                                            <label class="form-label" for="customer">Customer</label>
                                                                            <select id="customer{{ $act->id }}" name="id_customer" class="form-select" onchange="GetProject('{{ $act->id }}', this.value)">
                                                                                <option value="">Select</option>
                                                                                @foreach ($customers as $cst)
                                                                                    <option value="{{ $cst->id }}" {{ $cst->id == $act->id_customer ? 'selected' : '' }}>
                                                                                        {{ $cst->name }}
                                                                                    </option>
                                                                                @endforeach
                                                                            </select>
                                                                        ...
                                                                        <!-- Project Dropdown -->
                                                                        <div class="mb-4" id="project-container{{ $act->id }}" style="{{ $act->id_project ? '' : 'display: none;' }}">
                                                                            <label class="form-label" for="project">Project</label>
                                                                            <select id="project{{ $act->id }}" name="id_project" class="list-project form-select">
                                                                                <option value="">Select</option>
                                                                            </select>
                                                                        </div>
