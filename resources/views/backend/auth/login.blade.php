...
<head>
  ...
  <title>{{ $setting->nama_website }} - Login</title>
  <meta name="description" content="" />

  <!-- Favicon -->
  {{-- <link rel="icon" type="image/x-icon" href="{{ asset('assets/img/auth/penghargaan-main-logo.jpg') }}" /> --}}
  <link rel="icon" type="image/x-icon" href="{{ asset('assets/img/logo/' . $setting->logo) }}" />
                  ...
                  @endphp
                    ...
                    <div class="app-brand justify-content-center">
                        <a href="#" class="app-brand-link gap-2">
                            <center>
                                <img src="{{ asset('assets/img/logo/' . $setting->logo) }}" style="max-width: 100%">
                            </center>
                        </a>
                    </div>
                    <!-- /Logo -->
                    ...
                    <form id="loginForm" method="POST" action="{{ route('admin.login.submit') }}">
                      @csrf
                        ...
                        <div class="mb-3">
                            <button class="btn btn-primary d-grid w-100 text-white" type="submit" style="background: #f7931d!important">Sign in</button>
                        </div>
                    </form>
                </div>
            </div>
