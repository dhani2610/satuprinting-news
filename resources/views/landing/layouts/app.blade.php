...
<body class="index-page">
    <style>
        ...
        .product-grid:hover {
            border: 2px solid #ffbd7b !important;
        }
    </style>
    <style>
        :root {
        ...
        <div class="whatsapp-chat-window">
            ...
            <div class="whatsapp-chat-body">
                <p class="whatsapp-chat-bubble">
                    ...
                    Silahkan hubungi admin kami untuk mengetahui lebih lanjut tentang printing.com
                </p>
                <a href="https://wa.me/6282210008380" class="whatsapp-chat-btn">
                    Contact
                </a>
            </div>
        </div>
