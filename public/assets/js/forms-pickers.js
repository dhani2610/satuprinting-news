...
(function () {
    ...
    const flatpickrDate = document.querySelector("#flatpickr-date"),
        ...
        flatpickrDisabledRange = document.querySelector(
...
$(function () {
    ...
    var bsRangePickerBasic = $("#bs-rangepicker-basic"),
        ...
        bsRangePickerDropdownStart = $("#bs-rangepicker-dropdown-start"),
        bsRangePickerDropdownDeadline = $("#bs-rangepicker-dropdown-deadline"),
        bsRangePickerDropdownCreatedAt = $("#bs-rangepicker-dropdown-created-at");
    console.log("masuk");
    ...
    const startOfMonth = now.clone().startOf("month").format("MM/DD/YYYY");
    const endOfMonth = now.clone().endOf("month").format("MM/DD/YYYY");

    // Initialize the date range picker with default dates set to the current month
    ...
    // Initialize the date range picker with default dates set to the current month
    if (bsRangePickerDropdownStart.length) {
        bsRangePickerDropdownStart.daterangepicker({
            startDate: startOfMonth,
            endDate: endOfMonth,
            showDropdowns: true,
            opens: isRtl ? "left" : "right",
    ...
    if (bsRangePickerDropdownDeadline.length) {
        bsRangePickerDropdownDeadline.daterangepicker({
            startDate: startOfMonth,
            endDate: endOfMonth,
            showDropdowns: true,
            opens: isRtl ? "left" : "right",
    ...
    if (bsRangePickerDropdownCreatedAt.length) {
        bsRangePickerDropdownCreatedAt.daterangepicker({
            startDate: startOfMonth,
            endDate: endOfMonth,
            showDropdowns: true,
            opens: isRtl ? "left" : "right",
